...
class AndroidPhone extends SmartPhone{
    ...
    remainingAmount(priceIHave){
        ...
        else if(this.price<0) return "Customer can't able to buy a phone due to insufficient amount";
    ...
    remainingAmount(priceIHave)
        {
            ...
            else return 'Customer has remaining Rs.'+this.price +' after buying an iphone';
        }
}
//MobileCampus
class MobileCampus{
